...
describe('CaixaDaLanchonete', () => {
    ...
    // testes extra: múltiplos itens sem o principal
    test.each([
        ['queijo com outros itens', 'debito', 'Item extra não pode ser pedido sem o principal', ['cafe,4', 'combo1,3', 'queijo,2']],
        ['chantily com outros itens', 'debito', 'Item extra não pode ser pedido sem o principal', ['sanduiche,3', 'combo2,4', 'chantily,2']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));

    // queria fazer um teste com múltiplos itens com extras mas quase todos
    // os testes de preço possuem principal + extra
});